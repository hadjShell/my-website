...
![boxModel](/assets/image/javascript/boxModel.png)
...
@media (min-width: 900px), (max-width: 800px) {
} /* OR */
...
- Responsive Web Site
  ...
  - 12-Column Grid Responsive Layout
    ...
    ![12-columnGrid](/assets/image/javascript/12-columnGrid.png)

    nested grid

    ![nestedGrid](/assets/image/javascript/nestedGrid.png)
...
![bootstrapGrid](/assets/image/javascript/bootstrapGrid.png)
